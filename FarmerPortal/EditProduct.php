                            ...
                            <div class="card-body">
                                ...
                                <form name="my-form" action="InsertProduct.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="full_name" class="form-control" name="product_title" placeholder="<?php echo htmlspecialchars($product_title); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="full_name" class="form-control" name="product_stock" placeholder="<?php echo htmlspecialchars($product_stock); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="product_desc" id="nid_number2" class="form-control" rows="3" required><?php echo htmlspecialchars($product_desc); ?></textarea>
                                        </div>
                                    </div>
